...
$(document).ready(function() {
	...
	var path = "";//"http://lighthouse.adobe.com/users/derek/default_library_v26/";
	...
	var jsFiles = [path + "js/controls/DropDown.js?r=" + Math.random(), 				// Drop down that displays a list of items to select from.
	               ...
	               path + "js/controls/ToggleButton.js?r=" + Math.random(),				// Button which toggles between two states when pressed.
