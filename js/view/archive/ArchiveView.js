...
ADOBE.ArchiveView = Backbone.View.extend({
	...
	initialize: function() {
		...
		var html  = "<div id='header'>";
			...
			html +=     	"<div class='grey-button button' id='close-button'>Close</div>";
			html +=		"</div>";
			html +=		"<div id='title'>Select Issues</div>";
			html += 	"<div id='archive-view-right-column'>";
			html +=     	"<div class='grey-button button' id='select-all-button'>" + this.LBL_SELECT_ALL + "</div>";
			html +=     	"<div class='red-button button' id='remove-button'>Remove</div>";
			html +=		"</div>";
			html +=	"</div>";
